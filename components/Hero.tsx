...
const Hero = () => (
  <section className="container">
    ...
    <div className="flex flex-col items-start z-1 text-white">
      ...
      <p className="w-[80%]">
        I&apos;m a design-focused full-stack software engineer dedicated to
        creating beautiful interfaces & memorable experiences into real world
        solutions. Take a look into what I can do for you.
      </p>
